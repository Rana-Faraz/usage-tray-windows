(function () {
  ...
  function resolveStateDbs(ctx) {
    var paths = [
      "~/Library/Application Support/Antigravity IDE/User/globalStorage/state.vscdb",
      "~/Library/Application Support/Antigravity/User/globalStorage/state.vscdb",
    ]
    var isWindows = ctx.app.platform === "windows" || ctx.app.platform === "win32"
    if (isWindows && ctx.host.windows && typeof ctx.host.windows.knownPath === "function") {
